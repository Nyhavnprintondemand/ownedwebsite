        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-2xl font-bold text-gray-900 tracking-normal group-hover:text-accent-orange transition-colors duration-300">ZM PREMIUM</span>
              <span className="text-[10px] font-bold gradient-text -mt-1">PRINT ON DEMAND</span>
            </div>
          </Link>
