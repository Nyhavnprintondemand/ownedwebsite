    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/design" className="text-gray-300 hover:text-accent-orange transition-colors">Design selv</Link></li>
              <li><Link to="/produkter" className="text-gray-300 hover:text-accent-orange transition-colors">Produkter</Link></li>
              <li><Link to="/om-os" className="text-gray-300 hover:text-accent-orange transition-colors">Om os</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/handelsbetingelser" className="text-gray-300 hover:text-accent-orange transition-colors">Handelsbetingelser</Link></li>
              <li><Link to="/privatlivspolitik" className="text-gray-300 hover:text-accent-orange transition-colors">Privatlivspolitik</Link></li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400">
          <p>&copy; 2025 Nyhavn Print-on-Demand. Alle rettigheder forbeholdes.</p>
