  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Values Section */}
        <div className="premium-card rounded-2xl p-8 mb-16 animate-fade-in-up animate-delay-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center animate-fade-in-up animate-delay-100 group hover-tilt">
            ...
            <div className="text-center animate-fade-in-up animate-delay-200 group hover-tilt">
              <div className="w-16 h-16 bg-gradient-to-br from-accent-orange to-accent-orange-light rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 animate-pulse-glow">
            ...
            <div className="text-center animate-fade-in-up animate-delay-300 group hover-tilt">
              <div className="w-16 h-16 bg-gradient-to-br from-accent-orange to-accent-orange-light rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 animate-pulse-glow">
        ...
        {/* Team Section */}
        <div className="premium-card rounded-2xl p-8 mb-16 animate-fade-in-up animate-delay-400">
          <h2 className="text-2xl font-bold mb-8 text-center font-playfair">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center hover-lift group animate-fade-in-up animate-delay-500">
          ...
          <div className="text-center hover-lift group animate-fade-in-up animate-delay-600">
          ...
          <div className="text-center hover-lift group animate-fade-in-up animate-delay-700">
          ...
          <div className="text-center hover-lift group animate-fade-in-up animate-delay-800">
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-br from-accent-orange via-accent-orange-light to-accent-orange rounded-2xl p-8 text-center text-white hover-lift animate-fade-in-up animate-delay-900 relative overflow-hidden">
