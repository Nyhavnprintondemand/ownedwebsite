                ...
                {filePreview && (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute top-10 right-0 bg-white rounded-lg shadow-xl px-3 py-2 opacity-0 group-hover/gear:opacity-100 transition-all duration-300 pointer-events-none group-hover/gear:pointer-events-auto z-30 min-w-max">
